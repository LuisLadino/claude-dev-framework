...
show_next_steps() {
    ...
    echo "   • Start with /research-stack - it researches best practices online"
    echo "   • All standards are just markdown files - easy to customize"
    echo "   • Use /verify after coding to check quality"
    echo ""
}
